...
void FPixelStreamingVideoInputViewport::OnWindowRendered(SWindow& InWindow)
#else
void FPixelStreamingVideoInputViewport::OnWindowRendered(SWindow& InWindow, void* Resource)
#endif
{
